 ...
 */
class UrlEntityRepository extends ServiceEntityRepository
{
    ...
    public function save(UrlEntity $entity, bool $flush = false): void
    {
    ...
    public function remove(UrlEntity $entity, bool $flush = false): void
    {
...
//    /**
//     * @return UrlEntity[] Returns an array of UrlEntity objects
//     */
...
//    public function findOneBySomeField($value): ?UrlEntity
//    {
//        return $this->createQueryBuilder('u')
//            ->andWhere('u.exampleField = :val')
//            ->setParameter('val', $value)
